...
gulp.task('demo', () => {
  runSequence('clean', 'clean:vendors', 'install:vendors', 'vendors', 'dev:html', 'dev:sass', 'dev:js');
});

gulp.task('build', () => {
  runSequence('clean', 'clean:vendors', 'install:vendors', 'vendors', 'build:html', 'build:sass', 'build:js');
});
